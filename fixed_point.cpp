...
int64_t fixed_point::Mul(int64_t a, int64_t b) {
    return (((int64_t) a * (int64_t) b) >> FIXED_FBITS);
}

int64_t fixed_point::Div(int64_t a, int64_t b) {
    return ((int64_t) a << FIXED_FBITS / (int64_t) b);
}

int64_t fixed_point::Add(int64_t a, int64_t b) {
    return (((int64_t) a + (int64_t) b));
}

int64_t fixed_point::Sub(int64_t a, int64_t b) {
    return (((int64_t) a - (int64_t) b));
}
...
newton_poly_interpolation(int64_t x, int64_t x1, int64_t x2, int64_t x3, int64_t f1, int64_t f2, int64_t f3) {
    int64_t b1 = f1;
    int64_t b2 = fixed_point::Div(fixed_point::Sub(f2, f1), fixed_point::Sub(x2, x1));
    int64_t b3 = fixed_point::Div(fixed_point::Sub(fixed_point::Div(fixed_point::Sub(f3, f2), fixed_point::Sub(x3, x2)),
                                                   fixed_point::Div(fixed_point::Sub(f2, f1), fixed_point::Sub(x2, x1))), fixed_point::Sub(x3, x1));
    int64_t result = fixed_point::Add(b1, fixed_point::Add(fixed_point::Mul(b2, fixed_point::Sub(x, x1)),
                                                           fixed_point::Mul(b3, fixed_point::Mul(fixed_point::Sub(x, x1), fixed_point::Sub(x, x2)))));
    return result;
}
