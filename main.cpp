...
float ADC_to_sensor(float sensor_value) {
    return (sensor_value * 10 / 1023);
}

float calc_pressure_pascal(float value){
    float pressure;
    float power;
...
static int64_t newton_poly_interpolation(int64_t x, int64_t x1, int64_t x2, int64_t x3, int64_t f1, int64_t f2, int64_t f3) {
    int64_t b1 = f1;
...
int64_t calculating_pressure(float value) {
    int64_t result = 0;
